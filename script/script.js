function on_input() {
    ...
    if ((jogo1su == jogo1c) && jogo1su != '' && jogo1c != '') {
        ptsu+=1
        ptc+=1
        golsu+= jogo1su
        golc+= jogo1c
    ...
    } else if((jogo1su > jogo1c) && jogo1su != '' && jogo1c != '') {
        ptsu+=3
        golsu+=jogo1su
        golc+=jogo1c
        vitsu+=1
    ...
    if ((jogo1b == jogo1se) && jogo1b != '' && jogo1se != '') {
        ptb+=1
        ptse+=1
        golb+= jogo1b
        golse+= jogo1se
        ...
        sortTable()
    } else if((jogo1b > jogo1se) && jogo1b != '' && jogo1se != '') {
        ptb+=3
        golb+=jogo1b
        golse+=jogo1se
        vitb+=1
    ...
    if ((jogo2c == jogo2se) && jogo2c != '' && jogo2se != '') {
        ptc+=1
        ptse+=1
        golc+= jogo2c
        golse+= jogo2se
        ...
        change_camaroes(ptc, jc, vitc, saldoc, golc)
        sortTable()
    } else if((jogo2c > jogo2se) && jogo2c != '' && jogo2se != '') {
        ptc+=3
        golc+=jogo2c
        golse+=jogo2se
        vitc+=1
    ...
    //Jogo Brasil x Suica
    if ((jogo2b == jogo2su) && jogo2b != '' && jogo2su != '') {
        ptb+=1
        ptsu+=1
        golb+= jogo2b
        golsu+= jogo2su
        ...
        change_suica(ptsu, jsu, vitsu, saldosu, golsu)
        sortTable()
    } else if((jogo2b > jogo2su) && jogo2b != '' && jogo2su != '') {
        ptb+=3
        golb+=jogo2b
        golsu+=jogo2su
        vitb+=1
    ...
    if ((jogo3c == jogo3b) && jogo3c != '' && jogo3b != '') {
        ptc+=1
        ptb+=1
        golc+= jogo3c
        golb+= jogo3b
    ...
    } else if((jogo3c > jogo3b) && jogo3c != '' && jogo3b != '') {
        ptc+=3
        golc+=jogo3c
        golb+=jogo3b
        vitc+=1
    ...
    //Jogo Servia x Suiça
    if ((jogo3se == jogo3su) && jogo3se != '' && jogo3su != '') {
        ptse+=1
        ptsu+=1
        golse+= jogo3se
        golsu+= jogo3su
        ...
        change_suica(ptsu, jsu, vitsu, saldosu ,golsu)
        sortTable()
    } else if((jogo3se > jogo3su) && jogo3se != '' && jogo3su != '') {
        ptse+=3
        golse+=jogo3se
        golsu+=jogo3su
        vitse+=1
...
function better_play(ptb, ptsu, ptc, ptse){
    var pontuacao = [ptb, ptsu, ptc, ptse]
    var lista = pontuacao.sort()
